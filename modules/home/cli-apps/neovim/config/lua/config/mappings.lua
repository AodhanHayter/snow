...
map('n', '<leader>T', ':lua require("fff").live_grep()<cr>', options)
...
vim.keymap.set('n', '<leader>en', vim.diagnostic.goto_next, options)
vim.keymap.set('n', '<leader>ep', vim.diagnostic.goto_prev, options)
