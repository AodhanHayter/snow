...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    environment.etc."nix/nix.custom.conf".text = ''
      ...
      extra-substituters = https://nixpkgs-python.cachix.org https://devenv.cachix.org https://herdr-nix.cachix.org https://claude-code.cachix.org https://nix-community.cachix.org https://pi.cachix.org
